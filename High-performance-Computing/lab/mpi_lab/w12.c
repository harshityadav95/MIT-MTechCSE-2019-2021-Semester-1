...
MPI_Recv(&len,1,MPI_INT,1,4,MPI_COMM_WORLD,&status);
...
else if(myrank == 1)
{
    ...
    MPI_Ssend(&len,1,MPI_INT,0,4,MPI_COMM_WORLD);
    MPI_Ssend(message1,len,MPI_CHAR,0,3,MPI_COMM_WORLD);
